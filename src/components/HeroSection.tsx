        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              4th-year Computer Science student passionate about coding, creative tech, and innovation. 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button 
              ...
              className="group relative overflow-hidden bg-transparent border-2 border-primary text-primary hover:text-primary-foreground font-rajdhani font-semibold px-8 py-3 rounded-lg transition-all duration-300"
            >
            ...
            <Button 
              ...
              className="group relative overflow-hidden bg-gradient-cyber text-primary-foreground font-rajdhani font-semibold px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105"
            >
              <span className="relative flex items-center gap-2">
                <Briefcase size={20} />
                My Works
          ...
          <div className="flex justify-center">
            <button 
              ...
              className="animate-bounce neon-glow p-2 rounded-full"
            >
